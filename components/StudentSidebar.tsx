...
import { 
  LayoutDashboard, Briefcase, User, Bell, LogOut, Loader2, Building2
} from "lucide-react"
import { MobileNav } from "@/components/MobileNav" // ✅ Reuse MobileNav
...
export function StudentSidebar() {
  ...
  // Adapter for MobileNav (expects 'name' instead of 'label')
      ...
      <aside className="hidden lg:flex w-72 bg-white border-r border-gray-200 flex-col sticky top-0 h-screen z-40">
        ...
        <div className="p-8 pb-4">
          <div className="flex items-center gap-2.5 mb-8">
            ...
            <div>
                <span className="font-bold text-xl tracking-tight text-gray-900 block leading-none">
                  CampusHire
                </span>
        ...
        <div className="mt-auto p-6 border-t border-gray-100 bg-gray-50/50">
           <div className="flex items-center gap-3 mb-4 p-3 bg-white rounded-xl border border-gray-200 shadow-sm">
             <div className="w-9 h-9 rounded-full bg-gradient-to-br from-green-400 to-emerald-600 flex items-center justify-center text-white text-xs font-bold shadow-sm">
               ST
             </div>
           ...
           <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-red-600 hover:bg-red-50 rounded-xl text-sm font-medium transition-all border border-transparent hover:border-red-100"
          >
